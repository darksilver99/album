...
import 'view_album_page_model.dart';
export 'view_album_page_model.dart';

class ViewAlbumPageWidget extends StatefulWidget {
  const ViewAlbumPageWidget({super.key});
...
class _ViewAlbumPageWidgetState extends State<ViewAlbumPageWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ViewAlbumPageModel());
  }
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: Stack(
            children: [
              if (_model.albumSelected == null || _model.albumSelected == '')
                Padding(
              ...
              if (_model.albumSelected != null && _model.albumSelected != '')
                Column(
                  ...
                  children: [
                    ...
                    if (_model.albumSelected == 'album1')
                      Expanded(
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              8.0, 0.0, 8.0, 0.0),
                          child: Builder(
                            builder: (context) {
                              final photoList1 = FFAppState().album1.toList();
                    ...
                    if (_model.albumSelected == 'album2')
                      Expanded(
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              8.0, 0.0, 8.0, 0.0),
                          child: Builder(
                            builder: (context) {
                              final photoList2 = FFAppState().album2.toList();
                    ...
                    if (_model.albumSelected == 'album3')
                      Expanded(
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              8.0, 0.0, 8.0, 0.0),
                          child: Builder(
                            builder: (context) {
                              final photoList3 = FFAppState().album3.toList();
                    ...
                    if (_model.albumSelected == 'album4')
                      Expanded(
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              8.0, 0.0, 8.0, 0.0),
                          child: Builder(
                            builder: (context) {
                              final photoList4 = FFAppState().album4.toList();
